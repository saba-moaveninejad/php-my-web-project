                            ...
                            <ul class="nav flex-column pe-3">
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/php-personal-blog/admin-panel/index.php">
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/php-personal-blog/admin-panel/pages/posts/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/php-personal-blog/admin-panel/pages/categories/index.php" 
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    ...
                                    >
                                        ...
                                        <span class="fw-bold">Commenti</span>
                                    </a>
                                </li>
